"""
Write a function powerball that takes no arguments
and prints the message:
"Today's numbers are %, %, %, %, and %. The Powerball number is %.".
The first five numbers should be random integers
in the range [1,60), at least 1, but less than 60.
...
Use the random module and the function random.randrange
to generate the appropriate random numbers.
"""
